...
<!DOCTYPE html>
<!--
Add a calender event page for Trinity High School
-->
<html>
    <head>
        ...
        <div class="content">
            ...
            <div class="container" style="margin-top: 140px">
                <div class="panel panel-info">
                        <div class="panel-heading login_header">Add Calendar Event</div>
                        <div class="panel-body">
                            <form action="cal_add_submit.php" method="POST">
